...
import { AlertDialogDescription, AlertDialogHeader, AlertDialog, AlertDialogContent, AlertDialogTrigger, AlertDialogFooter, AlertDialogCancel, AlertDialogAction } from "../ui/alert-dialog"
...
export function EventForm({event,}:{
    ...
    async function onSubmit(values: z.infer<typeof eventFormSchema>) {
        ...
        try {
            ...
            form.setError("root", {
                message: `There was an error when saving your event ${error.message}`,
            }) 
        }
    }
    ...
    return(
        <Form {...form}>
            ...
            className="flex gap-6 flex-col">
                ...
                <FormField control={form.control} name="durationInMinutes"
                render={({ field }) => (
                    <FormItem>
                ...
                render={({ field }) => (
                    <FormItem>
                        ...
                        <FormControl><Textarea className="resize-none h-32" {...field}/></FormControl>
                    ...
                    {event && (
                        <AlertDialog>
                            ...
                            <AlertDialogContent>
                                ...
                                AND will permanently remove this event.</AlertDialogDescription>
                                </AlertDialogHeader>
                                <AlertDialogFooter>
